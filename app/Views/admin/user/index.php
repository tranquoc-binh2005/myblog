<div class="card-box">
    <h4 class="header-title"><?= $sub['user']['title']['index'] ?></h4>
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
        <li class="breadcrumb-item active"><?= $sub['user']['title']['index'] ?></li>
    </ol>
        ...
        <div class="ul right-0 position">
            <li>
                ...
                <ul class="dropdown-menu">
                    <li>
                        <a class="publishAll" data-field="user" data-column="publish" data-value="2"
                            href="#">Xuất bản</a>
                    </li>
                    <li>
                        <a class="publishAll" data-field="user" data-column="publish" data-value="1"
                            href="#">Huỷ
                            xuất bản</a>
                    </li>
                </ul>
    ...
    <form action="" method="GET">
        <div class="filter-box">
            <a class="btn btn-info" href="tao-thanh-vien"><?= $sub['user']['title']['create'] ?> </a>
        ...
        <table class="table mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $val['name'] ?></td>
                    <td><img src="<?= $val['image'] ?>" alt="Hình ảnh khách hàng"></td>
                    <td><?= $val['email'] ?></td>
                    <td><?= $val['userCatalogue_name'] ?></td>
                    <td>
                        <p>Sđt: 0949652939</p>
                        <p>Địa chỉ: 551/263/22 le van khuong</p>
                        <p>Ghi chu: toi la nguoi huong noi</p>
                    </td>
                    <th>
                        <?php if ($data['flag'] == 1): ?>
                        <input type="checkbox" <?= $val['publish'] == 1 ? 'checked' : '' ?> data-plugin="switchery"
                            ...
                            class="changeStatusPublish location-<?= $val['id'] ?>" data-filed="user"
                    ...
                    ?>
                    <th>
                        <a style="font-size: 20px;" href="sua-thanh-vien/<?= $val['id'] ?>"><i class="fe-edit"></i> </a>
                        <a style="font-size: 20px; color:rgb(241, 55, 55);" href="xoa-thanh-vien/<?= $val['id'] ?>"><i
                                class="fe-trash"></i></a>
                    </th>
                    <?php } else {?>
                    <th>
                        <a style="font-size: 20px;" title="Đưa trở lại" href="hoan-tac-thanh-vien/<?= $val['id'] ?>">
                            <i class="fe-rotate-ccw"></i>
                        </a>
                        <a style="font-size: 20px; color:rgb(241, 55, 55);" title="Xoá vĩnh viễn"
                            href="xoa-thanh-vien-vinh-vien/<?= $val['id'] ?>">
                            <i class="fe-trash"></i>
                        </a>
...
<ul class="pagination">
    <li class="page-item <?= $currentPage == 1 ? 'disabled' : '' ?>">
        <a class="page-link" href="thanh-vien?page=<?= $currentPage - 1 ?>" aria-label="Previous">
    ...
    <li class="page-item <?= $i == $currentPage ? 'active' : '' ?>">
        <a class="page-link" href="thanh-vien?page=<?= $i ?>"><?= $i ?></a>
    </li>
    <?php endfor; ?>

    <li class="page-item <?= $currentPage == $totalPages ? 'disabled' : '' ?>">
        <a class="page-link" href="thanh-vien?page=<?= $currentPage + 1 ?>" aria-label="Next">
            <span aria-hidden="true">»</span>
