                    ...
                    <div class="media align-items-center">
                        <div class="media-body">
                            ...
                            <h3 class="m-0 font-weight-normal text-white sp-line-1 cta-box-title">Special launcing
                                <b>Discount</b> offer</h3>
                            <p class="text-white-50 mt-2 sp-line-2">Suspendisse vel quam malesuada, aliquet sem sit
                                amet, fringilla elit. Morbi tempor tincidunt tempor. Etiam id turpis viverra.</p>
                            <a href="javascript: void(0);" class="text-white font-weight-semibold text-uppercase">Read
                                More <i class="mdi mdi-arrow-right"></i></a>
                        </div>
                        <img class="ml-3" src="serve\assets\images\update.svg" width="120"
                    ...
                    <div id="cardCollpase4" class="collapse pt-3 show">
                        <div class="row">
                            ...
                            <div class="col-md-4 align-self-center">
                                ...
                                <h5 class="mb-1 mt-0">51,480 <small class="text-muted ml-2">www.youtube.com</small>
                                </h5>
                                <div class="progress-w-percent">
                                ...
                                <h5 class="mb-1 mt-0">98,512 <small class="text-muted ml-2">www.behance.net</small>
                                </h5>
                                <div class="progress-w-percent">
                            ...
                            <div class="timeline-alt">
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-item-info">
                                        <a href="#" class="text-body font-weight-semibold mb-1 d-block">You sold
                                            an item</a>
                                ...
                                <div class="timeline-item">
                                    <i class="timeline-icon"></i>
                                    <div class="timeline-item-info">
                                        <a href="#" class="text-body font-weight-semibold mb-1 d-block">Product
                                ...
                                <div class="timeline-item">
                                    <i class="timeline-icon"></i>
                                    <div class="timeline-item-info">
                                        <a href="#" class="text-body font-weight-semibold mb-1 d-block">Audrey
                                            Tobey</a>
                ...
                <div class="table-responsive">
                    <table class="table table-borderless table-hover table-centered table-nowrap m-0">
                        ...
                        <tbody>
                            <tr>
                                <td style="width: 36px;">
                                    <img src="serve\assets\images\users\user-2.jpg" alt="contact-img"
                            ...
                            <tr>
                                <td style="width: 36px;">
                                    <img src="serve\assets\images\users\user-3.jpg" alt="contact-img"
                                        title="contact-img" class="rounded-circle avatar-sm">
                                </td>
                            ...
                            <tr>
                                <td style="width: 36px;">
                                    <img src="serve\assets\images\users\user-4.jpg" alt="contact-img"
                                        title="contact-img" class="rounded-circle avatar-sm">
                                </td>
                            ...
                            <tr>
                                <td style="width: 36px;">
                                    <img src="serve\assets\images\users\user-5.jpg" alt="contact-img"
                                        title="contact-img" class="rounded-circle avatar-sm">
                                </td>
                            ...
                            <tr>
                                <td style="width: 36px;">
                                    <img src="serve\assets\images\users\user-6.jpg" alt="contact-img"
                                        title="contact-img" class="rounded-circle avatar-sm">
                                </td>
