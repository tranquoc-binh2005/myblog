  ...
  <div class="navbar-custom">
      <ul class="list-unstyled topnav-menu float-right mb-0">
                  ...
                  <div class="slimscroll noti-scroll">
                      ...
                      <a href="javascript:void(0);" class="dropdown-item notify-item active">
                          <div class="notify-icon">
                              <img src="serve\assets\images\users\user-1.jpg" class="img-fluid rounded-circle"
                                  alt="">
                          </div>
                      ...
                      <a href="javascript:void(0);" class="dropdown-item notify-item">
                          <div class="notify-icon">
                              <img src="serve\assets\images\users\user-4.jpg" class="img-fluid rounded-circle"
                                  alt="">
                          </div>
          ...
          <li class="dropdown notification-list">
              <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect waves-light" data-toggle="dropdown"
                  ...
                  <img src="serve\assets\images\users\user-1.jpg" alt="user-image" class="rounded-circle">
      ...
      <div class="logo-box">
          <a href="index.html" class="logo text-center">
              <span class="logo-lg">
                  <img src="serve\assets\images\logo-light.png" alt="" height="24">
                  <!-- <span class="logo-lg-text-light">Upvex</span> -->
              </span>
              <span class="logo-sm">
                  <!-- <span class="logo-sm-text-dark">X</span> -->
                  <img src="serve\assets\images\logo-sm.png" alt="" height="28">
              </span>
          </a>
      </div>
