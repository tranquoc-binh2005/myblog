        ...
        <div class="col-md-2">
            <div class="form-row">
                <div class="form-group col-md-12">
                    ...
                    <select name="parent_id" class="form-control select-2">
                        ...
                        foreach ($data['dropDowns'] as $key => $dropDown) {
                            ...
                            $selected = $data['product']['parent_id'] == $dropDown['id'] ? 'selected' : '';
                ...
                <div class="form-group col-md-12 bg-light text-center">
                    <span class="image img-cover">
                        <img id="ckAvataImg" width="150px" class="image-target"
                            src="<?= isset($data['product']['image']) && !empty($data['product']['image']) ? $data['product']['image'] : 'serve/assets/images/no_image.jpg' ?>"
                            alt="no images">
                    </span>
