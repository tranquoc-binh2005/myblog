                                                ...
                                                <div class="tab-content b-0 mb-0 pt-0">
                                                    ...
                                                    <ul class="list-inline wizard mb-0">
                                                        <li class="previous list-inline-item">
                                                            <a href="javascript: void(0);" class="btn btn-light">Previous</a>
                                                        </li>
                                                        <li class="next list-inline-item float-right">
                                                            <a href="javascript: void(0);" class="btn btn-light">Next</a>
                                                        </li>
                                                    </ul>
                                        ...
                                        <div id="btnwizard">
                                            ...
                                            <div class="tab-content mb-0 b-0 pt-0">
                                                ...
                                                <div class="float-right">
                                                    <input type='button' class='btn btn-light button-next' name='next' value='Next'>
                                                    <input type='button' class='btn btn-light button-last' name='last' value='Last'>
                                                </div>
                                                <div class="float-left">
                                                    <input type='button' class='btn btn-light button-first' name='first' value='First'>
                                                    <input type='button' class='btn btn-light button-previous' name='previous' value='Previous'>
                                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div id="rootwizard">
                                            ...
                                            <div class="tab-content mb-0 b-0 pt-0">
                                                ...
                                                <ul class="list-inline wizard mb-0">
                                                    <li class="previous list-inline-item"><a href="javascript: void(0);" class="btn btn-light">Previous</a>
                                                    </li>
                                                    <li class="next list-inline-item float-right"><a href="javascript: void(0);" class="btn btn-light">Next</a></li>
                                                </ul>
