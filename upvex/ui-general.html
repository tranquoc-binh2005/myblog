                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="card-box">
                                    ...
                                    <h6 class="mb-0">Example heading <span class="badge badge-secondary">New</span></h6>
                                </div> <!-- end card-box -->
                            </div> <!-- end col-->
                            ...
                            <div class="col-lg-6">
                                <div class="card-box">
                                    ...
                                    <h6 class="mb-0">Example heading <span class="badge badge-secondary badge-pill">New</span></h6>
                                </div> <!-- end card-box -->
                            </div> <!-- end col-->
                        </div>
                        <!-- end row -->
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="card-box">
                                    ...
                                    <h6 class="mb-0">Example heading <span class="badge badge-light-secondary">New</span></h6>
                                </div> <!-- end card-box -->
                            </div> <!-- end col-->
                            ...
                            <div class="col-lg-6">
                                <div class="card-box">
                                    ...
                                    <h6 class="mb-0">Example heading <span class="badge badge-light-secondary badge-pill">New</span></h6>
                                </div> <!-- end card-box -->
                            </div> <!-- end col-->
                        </div>
                        <!-- end row -->
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <h4 class="header-title mt-3 mt-md-0">Breadcrumb</h4>
                                                <p class="text-muted">
