                ...
                <div class="form-group col-md-12">
                    ...
                    <select name="parent_id" class="form-control">
                        ...
                        foreach ($data['dropDowns'] as $key => $dropDown) {
                            ...
                            $selected = $data['postCatalogue']['parent_id'] == $dropDown['id'] ? 'selected' : '';
                ...
                <div class="form-group col-md-12 bg-light text-center">
                    <span class="image img-cover">
                        <img id="ckAvataImg" width="150px" class="image-target"
                            src="<?= isset($data['postCatalogue']['image']) && !empty($data['postCatalogue']['image']) ? $data['postCatalogue']['image'] : 'serve/assets/images/no_image.jpg' ?>"
                            alt="no images">
                    </span>
                    <input type="hidden" id="ckAvata" class="ck-target" name="image" value="<?= $data['postCatalogue']['image'] ?>">
                </div>
            </div>
