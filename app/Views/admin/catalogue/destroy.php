<div class="card-body row">
    <div class="col-md-6">
        <h4 class="header-title"><?= $sub['catalogue']['title']['delete'] ?></h4>
        <p class="text-muted font-13">Bạn có muốn xoá nhóm bài viết <span class="text-danger"><?=$data['catalogue']['name']?></span> này không?</p>
        <p class="text-danger">Lưu ý: Đây là hành động không thể hoàn tác!!!</p>
    </div>

    <form action="xoa-danh-muc-code/<?=$data['catalogue']['id']?>" method="POST" class="col-md-6">
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <input 
                    ...
                    class="form-control" 
                    readonly
                    value="<?=$data['catalogue']['canonical']?>.html"
                >
            </div>
        </div>
